 ...
 */
export const storeEphemeralKeyPair = (ekp) => localStorage.setItem("@aptos/ekp", encodeEphemeralKeyPair(ekp));
/**
 ...
 */
export const encodeEphemeralKeyPair = (ekp) => JSON.stringify(ekp, (_, e) => {
    if (typeof e === "bigint")
 ...
 */
export const decodeEphemeralKeyPair = (encodedEkp) => JSON.parse(encodedEkp, (_, e) => {
